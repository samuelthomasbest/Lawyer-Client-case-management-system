...
if (strlen($_SESSION['lccmsdbaid']==0)) {
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update lawyertable set AdminName='$AName', MobileNumber ='$mobno', Email= '$email' where ID='$adminid'");
    if ($query) {
...
<head>
    ...
    <!-- Title Page-->
    <title>LCCMS Admin Profile</title>
...
?>
                                        ...
                                        <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-primary btn-sm">Update Admin profile
                                        </button></p>
