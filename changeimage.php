...
move_uploaded_file($_FILES["img1"]["tmp_name"],"images/icon/".$_FILES["img1"]["name"]);
 $query=mysqli_query($con,"update clientcase set insertpic='$insertpic' where  id='$eid'");
 

    if ($query) {
    $msg="client Image has been Updated.";
   ...
   <a href="case-detail.php?editid=<?php echo $row['id'];?>"class="btn btn-primary btn-sm">Back</a>
                                              ...
                                              <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">change image </label>
                                                </div>
